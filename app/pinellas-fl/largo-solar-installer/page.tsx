...
export const metadata: Metadata = {
    ...
    description: "Professional solar installation in Largo, FL. Serving all Largo neighborhoods with Tesla Certified solar panels and Powerwall systems. Free consultation and quotes available!",
    keywords: [
        "Largo solar panels",
        "Largo Florida solar",
        "solar installation Largo",
        "Tesla Powerwall Largo",
        "residential solar Largo",
        "commercial solar Largo",
        "Largo solar installer",
    ...
    alternates: {
        canonical: "https://www.relentlessenergy.org/pinellas-fl/largo-solar-installer",
    },
    robots: {
        index: true,
        follow: true,
...
export default function LargoSolarInstallerPage() {
    const areaData = {
        name: "Largo",
        fullName: "Largo, Florida",
        description: "Largo residents are discovering the benefits of solar energy with our professional installation services. From established neighborhoods to new developments, we help Largo homeowners and businesses reduce energy costs while contributing to Florida's clean energy future.",
        ...
        testimonials: [
            {
                ...
                text: "Our solar system and battery backup kept our home comfortable during the last hurricane. Couldn't be happier with the investment!",
                rating: 5,
                systemSize: "7.6kW + Battery",
                installDate: "2023"
            },
            {
                name: "Steve Davis",
        ...
        permittingInfo: "City of Largo requires electrical permits for solar installations. We coordinate all permits and inspections."
    }
                ...
                <nav className="bg-white/80 backdrop-blur-sm border-b border-gray-100 py-4 mt-20 sticky top-20 z-40">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center space-x-2 text-sm text-gray-600">
                            ...
                            <ChevronRight className="h-4 w-4 text-gray-400" />
                            <span className="text-gray-900 font-medium">Largo Solar Installer</span>
                        </div>
                    </div>
                </nav>
                        ...
                        <ScrollReveal>
                            <div className="text-center mb-12">
                                ...
                                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                                    ...
                                    <span className="font-semibold text-blue-600">Largo</span>
                                </p>
                            </div>
                        </ScrollReveal>
