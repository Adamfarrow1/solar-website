...
export const metadata: Metadata = {
    ...
    description: "Premium solar installation in Palm Harbor, FL. Tesla Certified installer serving Innisbrook, Ozona, and all Palm Harbor communities. Custom solar solutions with 25-year warranties!",
    keywords: [
        "Palm Harbor solar panels",
        "Innisbrook solar",
        "Ozona solar installation",
        "Palm Harbor Tesla Powerwall",
        "luxury home solar Palm Harbor",
        "Florida solar installer",
        "Palm Harbor solar installer",
    ...
    alternates: {
        canonical: "https://www.relentlessenergy.org/pinellas-fl/palm-harbour-solar-installer",
    },
    robots: {
        index: true,
        follow: true,
...
export default function PalmHarborSolarInstallerPage() {
    const areaData = {
        name: "Palm Harbor",
        fullName: "Palm Harbor, Florida",
        description: "Palm Harbor's upscale communities and beautiful homes are perfect for premium solar installations. We serve from Innisbrook to Ozona, providing custom solar solutions that complement your home's architecture while delivering exceptional energy savings and environmental benefits.",
        ...
        testimonials: [
            {
                name: "Amanda Foster",
                neighborhood: "Innisbrook",
                text: "The Tesla Solar Roof on our home is absolutely stunning and generates more power than we expected. Neighbors constantly ask about it!",
                rating: 5,
                systemSize: "11.2kW Solar Roof",
                installDate: "2023"
            },
            {
                name: "Mark Thompson", 
        ...
        permittingInfo: "Pinellas County requires building permits for solar installations. We handle all county permits and inspections."
    }

    const structuredData = {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        name: "Relentless Energy - Palm Harbor Solar Installer",
        description: "Tesla Certified solar installation company serving Palm Harbor, Florida with residential and commercial solar solutions.",
        url: "https://relentlessenergy.org/pinellas-fl/palm-harbour-solar-installer",
                ...
                <nav className="bg-white/80 backdrop-blur-sm border-b border-gray-100 py-4 mt-20 sticky top-20 z-40">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex items-center space-x-2 text-sm text-gray-600">
                            ...
                            <ChevronRight className="h-4 w-4 text-gray-400" />
                            <span className="text-gray-900 font-medium">Palm Harbor Solar Installer</span>
                        </div>
                    </div>
                </nav>
                        ...
                        <ScrollReveal>
                            <div className="text-center mb-12">
                                ...
                                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                                    ...
                                    <span className="font-semibold text-blue-600">Palm Harbor</span>
                                </p>
                            </div>
                        </ScrollReveal>
