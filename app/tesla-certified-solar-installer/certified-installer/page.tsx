...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: "/tesla-certified-solar-installer/certified-installer",
    },
}
                    ...
                    <div className="text-center space-y-8 sm:space-y-12">
                        ...
                        <ScrollReveal direction="up" delay={400}>
                            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center max-w-2xl mx-auto px-4">
                                ...
                                >
                                    <Link href="tel:813-761-1631" className="flex items-center justify-center">
                                        <Phone className="mr-2 sm:mr-3 h-4 w-4 sm:h-5 sm:w-5 lg:h-6 lg:w-6 flex-shrink-0" />
                                        <span>(813) 761-1631</span>
                                    </Link>
                                </Button>
                            </div>
                        </ScrollReveal>
                        ...
                        <ScrollReveal direction="left" delay={0}>
                            <div className="group relative">
                                ...
                                <div className="relative bg-white rounded-2xl p-8 h-full flex flex-col">
                                    ...
                                    >
                                        <Link href="/tesla-certified-solar-installer/solar-roof-installation" className="flex items-center justify-center">
                        ...
                        <ScrollReveal direction="up" delay={100}>
                            <div className="group relative">
                                ...
                                <div className="relative bg-white rounded-2xl p-8 h-full flex flex-col">
                                    ...
                                    >
                                        <Link href="/tesla-certified-solar-installer/tesla-powerwall-installation" className="flex items-center justify-center">
                                            <span>Learn More</span>
                                            <ArrowRight className="ml-2 h-5 w-5 group-hover/btn:translate-x-1 transition-transform duration-300" />
                                        </Link>
                                    </Button>
                            ...
                            <div className="group relative">
                                ...
                                <div className="relative bg-white rounded-2xl p-8 h-full flex flex-col">
                                    ...
                                    <Button
                                        ...
                                        className="w-full bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group/btn"
                                    >
                                        <Link href="/solutions/home-solar-panel-installation" className="flex items-center justify-center">
                                            <span>Learn More</span>
                                            <ArrowRight className="ml-2 h-5 w-5 group-hover/btn:translate-x-1 transition-transform duration-300" />
                                        </Link>
                                    </Button>
