        ...
        <>
            ...
            <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-white pt-[140px] overflow-hidden">
                ...
                <div className="absolute inset-0">
                    ...
                    <div className="absolute top-32 right-20 w-24 h-24 border border-red-100 rounded-full opacity-40"></div>
                    <div className="absolute bottom-40 left-16 w-16 h-16 border border-orange-100 rotate-45 opacity-30"></div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <ScrollReveal direction="up">
                        <div className="text-center space-y-4 mb-16">
                            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900">Why Choose Solar for Your Home?</h2>
                        ...
                        <ScrollReveal direction="up" delay={0}>
                            <Card className="text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group border-gray-200 h-full flex flex-col">
                                <CardHeader className="flex-grow">
                                    ...
                                    <CardTitle className="text-xl text-gray-900">Massive Savings</CardTitle>
                                </CardHeader>
                        ...
                        <ScrollReveal direction="up" delay={100}>
                            <Card className="text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group border-gray-200 h-full flex flex-col">
                                <CardHeader className="flex-grow">
                                    ...
                                    <CardTitle className="text-xl text-gray-900">Increase Home Value</CardTitle>
                                </CardHeader>
                                <CardContent className="flex-grow flex items-center">
                                    <CardDescription className="text-base text-gray-600">
                        ...
                        <ScrollReveal direction="left">
                            <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group h-full flex flex-col">
                                <CardHeader className="flex-shrink-0">
                                    ...
                                    />
                                    <CardTitle className="text-2xl text-gray-900">Rooftop Solar Panels</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-4 flex-grow flex flex-col">
                                    ...
                                    <div className="pt-4 mt-auto">
                                        <div className="text-2xl font-bold text-red-600">Starting at $15,000</div>
                        ...
                        <ScrollReveal direction="up">
                            <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group border-red-200 h-full flex flex-col">
                                ...
                                <CardContent className="space-y-4 flex-grow flex flex-col">
                                    ...
                                    <div className="pt-4 mt-auto">
                                        <div className="text-2xl font-bold text-red-600">Custom Pricing</div>
                                        <div className="text-sm text-gray-500">Based on roof size & complexity</div>
                                    </div>
                                </CardContent>
                            </Card>
                        </ScrollReveal>
                            ...
                            <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group h-full flex flex-col">
                                <CardHeader className="flex-shrink-0">
                                    <Image
                                        ...
                                        className="w-full h-48 object-cover rounded-t-lg group-hover:scale-105 transition-transform duration-300"
                                    />
                                    <CardTitle className="text-2xl text-gray-900">Solar + Battery Storage</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-4 flex-grow flex flex-col">
                                    <CardDescription className="text-base text-gray-600">
                                    ...
                                    <div className="pt-4 mt-auto">
                                        ...
                                        <div className="text-sm text-gray-500">Solar + single Powerwall</div>
                                    </div>
                                </CardContent>
                            </Card>
                        </ScrollReveal>
                        ...
                        <ScrollReveal direction="right">
                            <Card className="text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-2 h-full flex flex-col">
                                <CardHeader className="flex-grow">
                                    ...
                                    <CardTitle className="text-2xl text-gray-900">Solar Lease/PPA</CardTitle>
                                </CardHeader>
                                <CardContent className="space-y-4 flex-grow flex flex-col">
                                    <CardDescription className="text-base text-gray-600 flex-grow">
            ...
            <section className="py-20 bg-gradient-to-r from-red-600 to-red-700">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <ScrollReveal direction="up">
                        <div className="space-y-8">
                            <h2 className="text-4xl lg:text-5xl font-bold text-white">Ready to Start Saving with Solar?</h2>
                            ...
                            <div className="flex flex-wrap items-center justify-center gap-8 pt-8">
                                ...
                                <div className="flex items-center space-x-3 bg-white bg-opacity-10 backdrop-blur-sm rounded-full px-4 py-2">
                                    <CheckCircle className="h-6 w-6 text-green-400" />
                                    <span className="text-white font-medium">Same Day Response</span>
                                </div>
                            </div>
                        </div>
                    </ScrollReveal>
