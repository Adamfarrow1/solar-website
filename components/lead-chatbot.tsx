    ...
    const submitLead = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                addBotMessage("Sorry, there was an issue. Please try calling us at (813) 761-1631")
            }
        } catch (error) {
            addBotMessage("Sorry, there was an issue. Please try calling us at (813) 761-1631")
        } finally {
        ...
        switch (currentStep) {
            case CONVERSATION_STEPS.GREETING:
                if (
                    ...
                    addBotMessage(
                        "No problem! If you change your mind, we're here to help you save on energy costs. Feel free to call us at (813) 761-1631 ☀️",
                    )
                    setCurrentStep(CONVERSATION_STEPS.COMPLETE)
                }
                break
